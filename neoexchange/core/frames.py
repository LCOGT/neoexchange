...
def measurements_from_block(blockid, bodyid=None):
    ...
    frames = Frame.objects.filter(block=block, frametype__in=(Frame.NEOX_RED_FRAMETYPE, Frame.BANZAI_RED_FRAMETYPE, Frame.STACK_FRAMETYPE)).values_list('id', flat=True)
