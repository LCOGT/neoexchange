...
class TestBestStandardsView(TestCase):
    ...
    def test_march_default_HA(self):
        ...
        expected_min_ra = 180 - 4*15
        expected_max_ra = 180 + 4*15
    ...
    def test_march_HA1(self):
        HA_hours = 1
        # Time is for March Equinox so anti-solar point is ~12h RA (=180 degrees)
        expected_min_ra = 180 - HA_hours*15
        expected_max_ra = 180 + HA_hours*15

        min_ra, max_ra = BestStandardsView.determine_ra_range(self, utc_dt=datetime(2019, 3, 20,  22, 00, 00), HA_hours=HA_hours)
    ...
    def test_after_sept_equinox_default_HA(self):
        ...
        expected_min_ra = (0 - 4*15) + 360
        expected_max_ra = 0 + 4*15

        min_ra, max_ra = BestStandardsView.determine_ra_range(self, utc_dt=datetime(2019, 9, 23,  7, 40, 50), dbg=True)
    ...
    def test_before_sept_equinox_default_HA(self):
        ...
        min_ra, max_ra = BestStandardsView.determine_ra_range(self, utc_dt=datetime(2019, 9, 23,  7, 40, 30), dbg=True)
