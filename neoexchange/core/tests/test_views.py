...
class TestCleanNEOCPObject(TestCase):
    ...
    def test_X33656(self):
        obs_page = [
            u'X33656  23.9  0.15  K1548 330.99052  282.94050   31.81272   13.02458  0.7021329  0.45261672   1.6800247                  3   1    0 days 0.21         NEOCPNomin',
    ...
    def test_findorb_without_replace(self):
        obs_page = [
            u'LSCTLFr 18.04  0.15 K158Q 359.91024    8.53879  335.41846    3.06258  0.1506159  0.29656016   2.2270374    FO 150826     3   1 10.4 min  0.08         Find_Orb   0000 LSCTLFr                     20150826',
            ]
        expected_elements = {}
        elements = clean_NEOCP_object(obs_page)
    ...
    def test_findorb_with_perturbers(self):
        ...
        obs_page = [
            u'CPTTL89 19.03  0.15 K159F 343.17326  209.67924  172.85027   25.18528  0.0920324  0.36954350   1.9232054    FO 150916    30   1    3 days 0.14 M-P 06  Find_Orb   0000 CPTTL89                     20150915',
            ]
        obs_page[0] = obs_page[0].replace('Find_Orb  ', 'NEOCPNomin')
    ...
    def test_findorb_with_min_units(self):
        ...
        obs_page = [
            u'ZTF00HU 32.92  0.15 K1837 199.07689  171.91365  166.14977    2.83538  0.4561885  1.73092232   0.6869909    FO 180921     8   1 87.0 min  1.21         Find_Orb   0000 ZTF00HU                     20180307',
            ]
        obs_page[0] = obs_page[0].replace('Find_Orb  ', 'NEOCPNomin')
    ...
    def test_findorb_with_hrs_units(self):
        ...
        obs_page = [
            u'ZTF00HU 32.92  0.15 K1837 199.07689  171.91365  166.14977    2.83538  0.4561885  1.73092232   0.6869909    FO 180921     8   1 87.0 hrs  1.21         Find_Orb   0000 ZTF00HU                     20180307',
            ]
        obs_page[0] = obs_page[0].replace('Find_Orb  ', 'NEOCPNomin')
    ...
    def test_findorb_with_permnumber(self):
        ...
        obs_page = [
            u'h6724   19.6   0.16 K156R 349.64418    8.64714  286.27302    4.64985  0.3751307  0.47926447   1.6171584  0 MPO342195   185   3 2011-2015 0.37 M-h 3Eh Find_Orb   0000         (436724) 2011 UW158 20150629',
            ]
        obs_page[0] = obs_page[0].replace('Find_Orb  ', 'NEOCPNomin')
    ...
    def test_findorb_with_permplusprov(self):
        ...
        obs_page = [
            u'h6724K11UF8W19.55  0K157A 355.88753    8.63457  286.27078    4.65085  0.3756709  0.47863758   1.6185701    FO 180921   339   1 2011-2015 0.33         Find_Orb   0000 (436724) = 2011 UW158       20150710',
            ]
        obs_page[0] = obs_page[0].replace('Find_Orb  ', 'NEOCPNomin')
    ...
    def test_findorb_local_discovery(self):
        ...
        obs_page_list = [
            u'LSCTLGj 16.54  0.15 K16B8 258.25752   52.27105  101.57581   16.82829  0.0258753  0.17697056   3.1419699    FO 161108    11   1    3 days 0.09         NEOCPNomin 0000 LSCTLGj                     20161108',
            u'',
            u'']
    ...
    def test_should_be_comets(self):
        ...
        obs_page = [
            u'P10vY9r 11.8  0.15  K167B 359.98102  162.77868  299.00048  105.84058  0.9976479  0.00002573 1136.349844                 66   1   35 days 0.42         NEOCPNomin',
            ]
    ...
    def test_should_be_comet_lowE(self):
        ...
        obs_page = [
            u'0046PJ54R02013.38  0K034B  41.15662  356.39037   82.16911   11.73795  0.6578477  0.18109548   3.0940760    FO 180921   621   1 1991-2003 53.4 M-N 06  NEOCPNomin 0000 P/46                        20030411',
            ]
    ...
    def test_should_be_comet_bad_start_year(self):
        ...
        obs_page = [
            u'0046PJ54R02013.38  0K034B  41.15662  356.39037   82.16911   11.73795  0.6578477  0.18109548   3.0940760    FO 180921   621   1 cRap-2003 53.4 M-N 06  NEOCPNomin 0000 P/46                        20030411',
            ]
    ...
    def test_should_be_comet_bad_last_year(self):
        ...
        obs_page = [
            u'0046PJ54R02013.38  0K034B  41.15662  356.39037   82.16911   11.73795  0.6578477  0.18109548   3.0940760    FO 180921   621   1 1991-CRAP 53.4 M-N 06  NEOCPNomin 0000 P/46                        20030411',
            ]
...
class TestScheduleCheck(TestCase):
    ...
    def test_time_cadence(self):
        ...
        expected_resp1['group_name'] = self.body_mp.current_name() + '_' + data['site_code'].upper() + '-' + \
                                       'cad-{}-{}'.format(datetime.strftime(data['utc_date'], '%Y%m%d'),
                                                          datetime.strftime(data['utc_date'], '%m%d'))
        expected_resp1['utc_date'] = date(2016, 4, 6).isoformat()
    ...
    def test_time_cadence_change_much(self):
        ...
        expected_resp1['proposal_code'] = data['proposal_code']
        expected_resp1['group_name'] = self.body_mp.current_name() + '_' + data[
            'site_code'].upper() + '-' + 'cad-{}-{}'.format(datetime.strftime(data['start_time'], '%Y%m%d'),
                                                            datetime.strftime(data['end_time'], '%m%d'))
        expected_resp1['utc_date'] = date(2016, 4, 7).isoformat()
    ...
    def test_mp_good_too(self):
        ...
        expected_resp1['proposal_code'] = data['proposal_code']
        expected_resp1['group_name'] = self.body_mp.current_name() + '_' + data[
            'site_code'].upper() + '-' + datetime.strftime(data['utc_date'], '%Y%m%d') + '_ToO'
        expected_resp1['utc_date'] = data['utc_date'].isoformat()
    ...
    def test_mp_good_spectro(self):
        ...
        expected_resp = {
            ...
            'group_name': self.body_mp.current_name() + '_' + data['instrument_code'][
                                                              0:3].upper() + '-' + datetime.strftime(data['utc_date'],
                                                                                                     '%Y%m%d') + '_spectra',
    ...
    def test_mp_cadence_short_name(self):
        ...
        expected_resp1['proposal_code'] = data['proposal_code']
        expected_resp1['group_name'] = self.body_mp.current_name() + '_' + data[
            'site_code'].upper() + '-cad-' + datetime.strftime(data['start_time'], '%Y%m%d') + '-' + datetime.strftime(
            data['end_time'], '%m%d')
        expected_resp1['utc_date'] = data['utc_date'].isoformat()
...
class TestUpdateMPCOrbit(TestCase):
    ...
    def test_243P_MPC(self, mock_class):
        ...
        for key in self.expected_elements_sp_comet:
            if key not in self.nocheck_keys and key != 'id':
                self.assertEqual(self.expected_elements_sp_comet[key], new_body_elements[key],
                                 msg="Failure on key: " + key)
    ...
    def test_C2016C2_April_epoch(self, mock_class):
        ...
        for key in self.expected_elements_comet_set1:
            if key not in self.nocheck_keys and key != 'id':
                self.assertEqual(self.expected_elements_comet_set1[key], new_body_elements[key],
                                 msg="Failure on key: " + key)
    ...
    def test_C2016C2_July_epoch(self, mock_class):
        ...
        for key in self.expected_elements_comet_set2:
            if key not in self.nocheck_keys and key != 'id':
                self.assertEqual(self.expected_elements_comet_set2[key], new_body_elements[key],
                                 msg="Failure on key: " + key)
    ...
    def test_C2017K2_April_epoch(self, mock_class):
        ...
        for key in self.expected_elements_dnc_comet_set1:
            if key not in self.nocheck_keys and key != 'id':
                self.assertEqual(self.expected_elements_dnc_comet_set1[key], new_body_elements[key],
                                 msg="Failure on key: " + key)
...
class TestIngestNewObject(TestCase):
    ...
    def setUp(self):
        ...
        self.orig_disc_orbit_file = os.path.abspath(
            os.path.join('astrometrics', 'tests', 'test_mpcorbit_LSCTLZZ.neocp'))
        ...
        self.orig_K11H00P_orbit_file = os.path.abspath(
            os.path.join('astrometrics', 'tests', 'test_mpcorbit_2011HP.neocp'))
    ...
    def _compare_bodies(self, body1, body2,
                        excluded_keys={'_state', '_prefetched_objects_cache', 'not_seen', 'ingest', 'update_time'}):
...
class TestCleanMPCOrbit(TestCase):
    ...
    def setUp(self):
        ...
        test_fh.close()
        self.test_comet_elements_2018Aug_epoch = parse_mpcorbit(self.test_multiple_epochs_page,
                                                                epoch_now=datetime(2018, 9, 25))
        self.test_comet_elements_2018Mar_epoch = parse_mpcorbit(self.test_multiple_epochs_page,
                                                                epoch_now=datetime(2018, 2, 14))
...
class TestCheckCatalogAndRefitNew(TestCase):
    ...
    def setUp(self):
        ...
        self.test_cat_good_wcs_not_BANZAI = os.path.abspath(
            os.path.join('photometrics', 'tests', 'ldac_test_catalog.fits'))
    ...
    def test_check_catalog_and_refit_new_good(self):
        ...
        expected_status_and_num_frames = (
        os.path.abspath(os.path.join(self.temp_dir, 'banzai_test_frame_ldac.fits')), 1)
    ...
    def test_BANZAI_catalog_found(self):
        ...
        expected_status_and_num_frames = (
        os.path.abspath(os.path.join(self.temp_dir, 'banzai_test_frame.fits'.replace('.fits', '_ldac.fits'))), 0)
    ...
    def test_matching_image_file_not_found_check_catalog_and_refit_new(self):
        ...
        status = check_catalog_and_refit(self.configs_dir, self.temp_dir,
                                         self.test_banzai_fits.replace('neox', 'neoxs'))
        ...
        status = check_catalog_and_refit(self.configs_dir, self.temp_dir,
                                         self.test_banzai_fits.replace('frame.fits', 'frames.fits'))

        self.assertEqual(expected_status_and_num_frames, status)

    def test_run_sextractor_good(self):

        expected_status_and_catalog = (
        0, os.path.join(self.temp_dir, os.path.basename(self.test_banzai_fits).replace('.fits', '_ldac.fits')))

        (status, new_ldac_catalog) = run_sextractor_make_catalog(self.configs_dir, self.temp_dir,
                                                                 self.test_banzai_fits.replace('.fits', '.fits[SCI]'))
    ...
    def test_make_new_catalog_entry_gaiadr2(self):
        ...
        status, new_header = updateFITSWCS(self.test_banzai_fits, self.test_externscamp_headfile,
                                           self.test_externcat_xml, fits_file_output)
    ...
    def test_make_new_catalog_entry_gaiadr2_tpv(self):
        ...
        fits_file_output = self.test_banzai_fits.replace('_frame', '_frame_new')
        status, new_header = updateFITSWCS(self.test_banzai_fits, self.test_externscamp_TPV_headfile,
                                           self.test_externcat_TPV_xml, fits_file_output)
        header = get_catalog_header(new_header, cattype)
        new_wcs = WCS(new_header)
        expected_wcs = new_wcs.wcs
        num_new_frames = make_new_catalog_entry(new_ldac_catalog, header, self.test_block)
...
class TestAddExternalSpectroscopyData(TestCase):
    ...
    def test_same_body_different_wavelength(self):
        expected_res = True
        test_obj = ['LNX0003', 'NIR', '', "spex/sp233/a416584.sp233.txt", "sp[233]",
                    datetime.strptime('2017-09-25', '%Y-%m-%d').date()]
    ...
    def test_same_body_older(self):
        expected_res = False
        test_obj = ['980', 'Vis', 'spex/sp233/a416584.sp234.txt', "", "sp[24]",
                    datetime.strptime('2015-09-25', '%Y-%m-%d').date()]
        new_spec = update_previous_spectra(test_obj, 'S', dbg=True)
    ...
    def test_same_body_newer(self):
        expected_res = True
        test_obj = ['980', 'Vis', 'spex/sp233/a416584.sp234.txt', "", "sp[24]",
                    datetime.strptime('2017-12-25', '%Y-%m-%d').date()]
        new_spec = update_previous_spectra(test_obj, 'S', dbg=True)
    ...
    def test_same_body_different_source(self):
        expected_res = True
        test_obj = ['980', 'Vis', '2014/09/1999sh10.png', "", "MANOS Site",
                    datetime.strptime('2015-09-25', '%Y-%m-%d').date()]
    ...
    def test_new_body(self):
        expected_res = False
        test_obj = ['9801', 'Vis', '2014/09/1999sh10.png', "", "MANOS Site",
                    datetime.strptime('2015-09-25', '%Y-%m-%d').date()]
        new_spec = update_previous_spectra(test_obj, 'M', dbg=True)
...
class TestUpdateElementsWithFindOrb(TestCase):
    ...
    def test_goodelements(self):
        ...
        site_code = 'Z21'
        elements_or_status = update_elements_with_findorb(self.source_dir, self.dest_dir, self.filename, site_code,
                                                          start_time)
    ...
    def test_bad_filename(self):
        ...
        elements_or_status = update_elements_with_findorb(self.source_dir, self.dest_dir, 'i_am_broken', site_code,
                                                          start_time)
...
class TestFindSpec(TestCase):
    ...
    def test_local_data_no_tarball(self):
        ...
        expected_path = os.path.join(expected_date,
                                     self.test_body.current_name() + '_' + self.test_block.request_number)
    ...
    def test_local_data_with_tarball(self):
        with self.settings(MEDIA_ROOT=tempfile.mkdtemp()):
            ...
            fake_tar = os.path.join(expected_date,
                                    self.eng_proposal.code + '_' + self.test_block.request_number + '.tar.gz')
...
class TestBuildVisibilitySource(TestCase):
    ...
    def test_build_visibility_source(self):
        ...
        expected_vis = {'x': [0, 0, 0, 0, 0, 0],
                        'y': [0, 0, 0, 0, 0, 0],
                        'sun_rise': [10.210176124166827, 8.595746566072073, 6.370451769779303, 4.625122517784973,
                                     9.381144729469522, 5.541420375081996],
                        'sun_set': [7.810348402674624, 6.239552075879727, 3.9706240482870996, 1.9634954084936207,
                                    6.719517620178169, 2.879793265790644],
                        ...
                        'moon_rise': [1.0471975511965979, -0.5235987755982989, 3.534291735288517, 1.7016960206944711,
                                      0.13089969389957457, 2.4870941840919194],
                        'moon_set': [3.4033920413889427, 1.7016960206944713, 5.759586531581287, 3.9269908169872414,
                                     2.356194490192345, 4.974188368183839],
                        'moon_phase': [0.8706345970199544, 0.8651789635607248, 0.8701262242502456, 0.8701177903593142,
                                       0.8645091870127206, 0.8712568525897345],
...
class TestParsePortalErrors(SimpleTestCase):
    ...
    def test_no_visibility(self):
        ...
        params = {'error_msg': {'requests': [{'non_field_errors': [
...
class TestMakeRequestForSatellite(SimpleTestCase):
    ...
    def test1(self):
        expected_params = {'exp_count': 10, 'exp_time': 3.5, 'filter_pattern': 'w,', 'site_code': 'W86',
