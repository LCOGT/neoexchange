...
class TestGetFitsImageStats(ExternalCodeUnitTest):
    ...
    def test_null_file(self):
        null_stats = get_fits_imagestats(None, 'mean', center = None, size = None)
        null_stats_center = get_fits_imagestats(None, 'mean', center = (600, 1370), size = None)
        null_stats_size = get_fits_imagestats(None, 'mean', center = None, size = (9, 9))
        null_stats_full = get_fits_imagestats(None, 'mean', center = (600, 1370), size = (9, 9))
    ...
    def test_mean_no_center(self):
        ...
        mean_no_center = get_fits_imagestats(self.test_banzai_file_COPIED, 'mean', center = None, size = None)
        mean_incomp_center = get_fits_imagestats(self.test_banzai_file_COPIED, 'mean', center = (600, 1370), size = None)
        mean_incomp_size = get_fits_imagestats(self.test_banzai_file_COPIED, 'mean', center = None, size = (9, 9))
    ...
    def test_median_no_center(self):
        ...
        median_no_center = get_fits_imagestats(self.test_banzai_file_COPIED, 'median', center = None, size = None)
        median_incomp_center = get_fits_imagestats(self.test_banzai_file_COPIED, 'median',  center = (600, 1370), size = None)
        median_incomp_size = get_fits_imagestats(self.test_banzai_file_COPIED, 'median', center = None, size = (9, 9))
    ...
    def test_std_no_center(self):
        ...
        std_no_center = get_fits_imagestats(self.test_banzai_file_COPIED, 'std', center = None, size = None)
        std_incomp_center = get_fits_imagestats(self.test_banzai_file_COPIED, 'std', center = (600, 1370), size = None)
        std_incomp_size = get_fits_imagestats(self.test_banzai_file_COPIED, 'std', center = None, size = (9, 9))
