...
def dark_and_object_up(emp, dark_start, dark_end, slot_length, alt_limit=30.0, debug=False):
    ...
    for x in emp:
        if len(x) >= 7:
            ...
            try:
                if (dark_start <= emp_time <= dark_end - timedelta(minutes=slot_length)) and current_alt >= round(float(alt_limit),2):
                    visible = True
...
#    bad_onem_site_codes = ['Q63', 'Q64']
    ...
    point4m_site_codes = ['Z21', 'Z17', 'W89', 'W79', 'T04', 'T03', 'Q58', 'Q59', 'V38', 'L09', 'V45', 'V99', '0M4']
...
def get_mountlimits(site_code_or_name):
    ...
    if '-1M0A' in site or site in ['V37', 'V39', 'W85', 'W86', 'W87', 'K91', 'K92', 'K93', 'Q63', 'Q64', 'Z31', 'Z24']:
        ...
        alt_limit = 30.0
    elif '-AQWA' in site or '-AQWB' in site or 'CLMA-0M4' in site or site in ['Z17', 'Z21', 'Q58', 'Q59', 'T03', 'T04', 'W89', 'W79', 'V38', 'L09', 'V45', 'V99']:
...
def get_sitecam_params(site, bin_mode=None):
    ...
    valid_point4m_codes = ['W89', 'W79', '0M4', 'Z17', 'Z21', 'T04', 'T03', 'Q58', 'Q59', 'V38', 'L09', 'V45', 'V99']
...
def determine_sites_to_schedule(sched_date=datetime.utcnow()):
    ...
    if 17 <= sched_date.hour < 23:
        ...
        N_point4m_sites = ['T04', 'T03', 'V38', 'V45', 'V99']
        N_onem_sites = ['V37', ]
