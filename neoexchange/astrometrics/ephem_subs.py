...
def get_mag_mapping(site_code):
    ...
    good_onem_site_codes = ['V37', 'V99', 'K91', 'K92', 'K93', 'W85', 'W86', 'W87', 'Q63', 'Q64', 'GOOD1M', '1M0']
...
def get_sitepos(site_code, dbg=False):
    ...
    elif site_code == 'ELP-DOMB' or site_code == 'V99':
...
def get_mountlimits(site_code_or_name):
    ...
    if '-1M0A' in site or site in ['V37', 'V99', 'W85', 'W86', 'W87', 'K91', 'K92', 'K93', 'Q63', 'Q64']:
