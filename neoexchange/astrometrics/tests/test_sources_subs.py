...
class TestFetchAreciboCalendarTargets(TestCase):
    ...
    def test_targets(self):
        expected_targets = [ # Yes these are wide, no they aren't going on a punched card, bite me...
                              { 'target' : '2020 HG9', 'windows' : [{'start' : datetime(2020,5,18,23,14), 'end' : datetime(2020,5,19, 1,31)}] },
                              { 'target' : '2020 JD2', 'windows' : [{'start' : datetime(2020,5,19, 5,32), 'end' : datetime(2020,5,19, 8, 6)}] },
                              { 'target' : '478784',   'windows' : [{'start' : datetime(2020,5,21, 6,57), 'end' : datetime(2020,5,21, 8,39)}] },
                              { 'target' : '2020 KA',  'windows' : [{'start' : datetime(2020,5,21,15, 3), 'end' : datetime(2020,5,21,17,26)}] },
                              { 'target' : '2020 JY1', 'windows' : [{'start' : datetime(2020,5,23, 8,39), 'end' : datetime(2020,5,23,11,39)}] },
                              { 'target' : '2020 KU2', 'windows' : [{'start' : datetime(2020,5,23,23,46), 'end' : datetime(2020,5,24, 1,32)}] },
                              { 'target' : '2020 KV1', 'windows' : [{'start' : datetime(2020,5,24, 1, 7), 'end' : datetime(2020,5,24, 2,59)}] },
                              { 'target' : '2020 KP',  'windows' : [{'start' : datetime(2020,5,24,13,28), 'end' : datetime(2020,5,24,14,52)}] },
                              { 'target' : '2020 KP3', 'windows' : [{'start' : datetime(2020,5,25, 0,10), 'end' : datetime(2020,5,25, 2,59)}] },
                              { 'target' : '2020 JN3', 'windows' : [{'start' : datetime(2020,5,25, 2,13), 'end' : datetime(2020,5,25, 3,53)}] },
                              { 'target' : '2020 KJ3', 'windows' : [{'start' : datetime(2020,5,25, 2,41), 'end' : datetime(2020,5,25, 5, 7)}] },
                              { 'target' : '2020 KJ',  'windows' : [{'start' : datetime(2020,5,26,13,47), 'end' : datetime(2020,5,26,16,15)}] },
                              { 'target' : '2020 KV',  'windows' : [{'start' : datetime(2020,5,27, 1,20), 'end' : datetime(2020,5,27, 3,21)}] },
                              { 'target' : '2020 KD3', 'windows' : [{'start' : datetime(2020,5,28,19,45), 'end' : datetime(2020,5,28,22,18)}] },
                              { 'target' : '2020 JV2', 'windows' : [{'start' : datetime(2020,5,29, 6,18), 'end' : datetime(2020,5,29, 9, 5)}] },
                              { 'target' : '2020 KE4', 'windows' : [{'start' : datetime(2020,5,31,23,25), 'end' : datetime(2020,6, 1, 1,41)}] },
                              { 'target' : '2020 KZ3', 'windows' : [{'start' : datetime(2020,6, 3, 3,37), 'end' : datetime(2020,6, 3, 4,36)}] },
                              { 'target' : '66391',    'windows' : [{'start' : datetime(2020,6, 3,21,12), 'end' : datetime(2020,6, 3,22,22)}] },
                              { 'target' : '2020 KD4', 'windows' : [{'start' : datetime(2020,6, 5, 4,42), 'end' : datetime(2020,6, 5, 5,51)}] },
                              { 'target' : '2020 KO1', 'windows' : [{'start' : datetime(2020,6, 6, 5,19), 'end' : datetime(2020,6, 6, 8, 5)}] },
                              { 'target' : '2020 KN2', 'windows' : [{'start' : datetime(2020,6, 6,10,42), 'end' : datetime(2020,6, 6,11,57)}] },
                              { 'target' : '2020 KJ1', 'windows' : [{'start' : datetime(2020,6, 7,13, 8), 'end' : datetime(2020,6, 7,15,23)}] },
                              { 'target' : '2013 XA22','windows' : [{'start' : datetime(2020,6, 8,20,46), 'end' : datetime(2020,6, 8,23,26)}] },
                              { 'target' : '2020 KB3', 'windows' : [{'start' : datetime(2020,6,11, 1,19), 'end' : datetime(2020,6,11, 2,25)}] },
                              { 'target' : '2016 JT38','windows' : [{'start' : datetime(2020,6,12,14,33), 'end' : datetime(2020,6,12,17,18)}] },
                              { 'target' : '2020 JU',  'windows' : [{'start' : datetime(2020,6,13, 8,56), 'end' : datetime(2020,6,13,11,39)}] },
                              { 'target' : '2005 MR5', 'windows' : [{'start' : datetime(2020,6,19, 3,53), 'end' : datetime(2020,6,19, 6, 8)}] },
                              { 'target' : '2020 KR1', 'windows' : [{'start' : datetime(2020,6,21, 5,55), 'end' : datetime(2020,6,21, 8,13)}] },
                              { 'target' : '144411',   'windows' : [{'start' : datetime(2020,6,21,13,39), 'end' : datetime(2020,6,21,15,21)}] },
                              { 'target' : '441987',   'windows' : [{'start' : datetime(2020,6,22,19, 5), 'end' : datetime(2020,6,22,20, 9)}] },
                              { 'target' : '2017 XL2', 'windows' : [{'start' : datetime(2020,6,23,20,50), 'end' : datetime(2020,6,23,23, 8)}] },
                              { 'target' : '2020 JX1', 'windows' : [{'start' : datetime(2020,6,28,18,25), 'end' : datetime(2020,6,28,19,56)}] },
                              { 'target' : '242450',   'windows' : [{'start' : datetime(2020,7, 8,10,41), 'end' : datetime(2020,7, 8,13,26)}] },
                              { 'target' : '2016 YO3', 'windows' : [{'start' : datetime(2020,7,10,16,27), 'end' : datetime(2020,7,10,18,55)}] },
                              { 'target' : '2006 NL',  'windows' : [{'start' : datetime(2020,7,11, 2,15), 'end' : datetime(2020,7,11, 4,53)}] },
                              { 'target' : '480936',   'windows' : [{'start' : datetime(2020,7,17, 8,49), 'end' : datetime(2020,7,17,11,19)}] },
                              { 'target' : '8014',     'windows' : [{'start' : datetime(2020,7,19,20,14), 'end' : datetime(2020,7,19,22, 5)}] },
                              { 'target' : '85989',    'windows' : [{'start' : datetime(2020,7,20,10,59), 'end' : datetime(2020,7,20,13, 7)}] },
                              { 'target' : '2015 FP332', 'windows' : [{'start' : datetime(2020,7,24,12,37), 'end' : datetime(2020,7,24,15,18)}] }
                           ]
