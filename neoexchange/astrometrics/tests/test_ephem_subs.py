...
class TestLongTermScheduling(TestCase):
    ...
    def test_LongTermScheduling_with_body2_shorter_time_limit(self):
        ...
        expected_returned_params = (['2017 01 09', '2017 01 16', '2017 01 17', '2017 01 18', '2017 01 19', '2017 01 20', '2017 01 21', '2017 01 22', '2017 01 23', '2017 01 24', '2017 01 25', '2017 01 26', '2017 01 27', '2017 01 28', '2017 01 29', '2017 01 30'], [['2017 01 09 08:30', '11 07 53.60', '-19 20 19.8', '21.5', ' 1.03', '162.0', '+30', '0.86', '106', '+26', '+021', '-02:18'], ['2017 01 16 08:25', '11 11 11.23', '-22 01 59.9', '21.3', ' 0.97', '172.4', '+30', '0.82', ' 28', '+53', '+012', '-01:59'], ['2017 01 17 08:25', '11 11 28.60', '-22 24 52.3', '21.3', ' 0.97', '174.1', '+30', '0.74', ' 27', '+42', '+016', '-01:55'], ['2017 01 18 08:25', '11 11 43.01', '-22 47 39.7', '21.2', ' 0.96', '175.9', '+30', '0.64', ' 31', '+31', '+020', '-01:51'], ['2017 01 19 08:25', '11 11 54.34', '-23 10 21.4', '21.2', ' 0.96', '177.8', '+30', '0.55', ' 38', '+20', '+023', '-01:48'], ['2017 01 20 08:25', '11 12 02.53', '-23 32 56.7', '21.2', ' 0.95', '179.7', '+30', '0.45', ' 47', '+09', '+027', '-01:44'], ['2017 01 21 08:25', '11 12 07.47', '-23 55 24.9', '21.1', ' 0.95', '181.7', '+30', '0.36', ' 56', '-01', '+030', '-01:40'], ['2017 01 22 08:25', '11 12 09.07', '-24 17 45.2', '21.1', ' 0.94', '183.7', '+30', '0.27', ' 66', '-11', '+034', '-01:36'], ['2017 01 23 08:20', '11 12 07.27', '-24 39 52.1', '21.1', ' 0.94', '185.8', '+30', '0.19', ' 76', '-22', '+037', '-01:37'], ['2017 01 24 08:20', '11 12 01.93', '-25 01 54.1', '21.0', ' 0.93', '188.0', '+30', '0.12', ' 86', '-33', '+041', '-01:33'], ['2017 01 25 08:20', '11 11 52.97', '-25 23 45.5', '21.0', ' 0.93', '190.2', '+30', '0.07', ' 96', '-43', '+044', '-01:29'], ['2017 01 26 08:20', '11 11 40.31', '-25 45 25.4', '21.0', ' 0.93', '192.5', '+30', '0.03', '107', '-53', '+047', '-01:25'], ['2017 01 27 08:20', '11 11 23.85', '-26 06 52.7', '20.9', ' 0.93', '194.8', '+30', '0.00', '117', '-62', '+050', '-01:21'], ['2017 01 28 08:20', '11 11 03.50', '-26 28 06.2', '20.9', ' 0.93', '197.2', '+30', '0.00', '127', '-70', '+053', '-01:16'], ['2017 01 29 08:20', '11 10 39.18', '-26 49 04.8', '20.8', ' 0.93', '199.6', '+30', '0.02', '136', '-71', '+053', '-01:12'], ['2017 01 30 08:25', '11 10 10.68', '-27 09 51.6', '20.8', ' 0.93', '202.1', '+30', '0.06', '143', '-66', '+052', '-01:03']], [4.083333333333333, 3.9166666666666665, 3.8333333333333335, 3.6666666666666665, 3.5833333333333335, 3.4166666666666665, 3.3333333333333335, 3.1666666666666665, 3.1666666666666665, 3.0, 2.9166666666666665, 2.75, 2.6666666666666665, 2.5, 2.3333333333333335, 2.0833333333333335], [39, 37, 36, 36, 36, 35, 35, 34, 34, 34, 33, 33, 33, 32, 32, 32])

        returned_params = monitor_long_term_scheduling(site_code, body_elements, utc_date=datetime(2017, 1, 6, 0, 0, 00), date_range=26, dark_and_up_time_limit=2.0)
    ...
    def test_LongTermScheduling_with_body3(self):
        ...
        expected_returned_params = (['2017 01 21', '2017 01 22', '2017 01 23', '2017 01 24', '2017 01 25', '2017 01 26', '2017 01 27', '2017 01 28', '2017 01 29', '2017 01 30', '2017 01 31', '2017 02 01'], [['2017 01 21 08:15', '13 31 15.01', '+13 18 31.1', '18.2', ' 8.80', '311.3', '+30', '0.36', ' 35', '-03', '+031', '-04:09'], ['2017 01 22 07:55', '13 20 59.76', '+15 30 00.5', '18.1', ' 8.43', '310.7', '+30', '0.27', ' 48', '-17', '+036', '-04:15'], ['2017 01 23 07:40', '13 10 56.80', '+17 33 59.8', '18.1', ' 8.04', '310.0', '+30', '0.20', ' 62', '-31', '+041', '-04:16'], ['2017 01 24 07:20', '13 01 11.14', '+19 29 22.9', '18.0', ' 7.65', '309.2', '+30', '0.13', ' 76', '-45', '+045', '-04:22'], ['2017 01 25 07:05', '12 51 39.02', '+21 16 57.8', '18.0', ' 7.25', '308.2', '+30', '0.07', ' 89', '-58', '+050', '-04:24'], ['2017 01 26 06:50', '12 42 22.99', '+22 56 25.1', '18.0', ' 6.87', '307.3', '+31', '0.03', '103', '-70', '+054', '-04:26'], ['2017 01 27 06:35', '12 33 23.36', '+24 27 57.9', '18.0', ' 6.49', '306.2', '+31', '0.01', '116', '-76', '+056', '-04:28'], ['2017 01 28 06:25', '12 24 38.51', '+25 52 11.8', '18.0', ' 6.13', '305.1', '+32', '0.00', '129', '-70', '+055', '-04:25'], ['2017 01 29 06:10', '12 16 12.37', '+27 08 51.3', '18.0', ' 5.78', '303.9', '+32', '0.02', '141', '-57', '+051', '-04:28'], ['2017 01 30 06:00', '12 08 01.37', '+28 18 53.6', '18.0', ' 5.46', '302.7', '+33', '0.05', '151', '-44', '+047', '-04:26'], ['2017 01 31 05:45', '12 00 09.11', '+29 22 12.6', '18.0', ' 5.14', '301.5', '+32', '0.11', '154', '-29', '+042', '-04:29'], ['2017 02 01 05:35', '11 52 32.14', '+30 19 41.3', '18.1', ' 4.84', '300.2', '+33', '0.19', '150', '-15', '+038', '-04:28']], [4.333333333333333, 4.666666666666667, 4.916666666666667, 5.25, 5.5, 5.75, 6.0, 6.166666666666667, 6.416666666666667, 6.583333333333333, 6.666666666666667, 6.833333333333333], [73, 75, 77, 79, 80, 82, 84, 85, 86, 87, 88, 89])
    ...
    def test_LongTermScheduling_with_body4(self):
        ...
        expected_returned_params = (['2017 01 26', '2017 01 27', '2017 01 28', '2017 01 29', '2017 01 30', '2017 01 31', '2017 02 01'], [['2017 01 26 06:40', '10 53 54.75', '-13 15 07.5', '21.5', ' 4.76', '294.8', '+30', '0.03', '116', '-72', '+054', '-02:47'], ['2017 01 27 06:25', '10 47 10.72', '-12 24 58.0', '21.4', ' 4.96', '295.4', '+30', '0.01', '129', '-76', '+055', '-02:52'], ['2017 01 28 06:10', '10 40 12.85', '-11 31 37.6', '21.3', ' 5.15', '296.1', '+30', '0.00', '141', '-68', '+052', '-02:56'], ['2017 01 29 05:55', '10 33 01.97', '-10 35 07.5', '21.2', ' 5.34', '296.7', '+30', '0.02', '153', '-55', '+048', '-03:00'], ['2017 01 30 05:40', '10 25 39.12', '-09 35 32.1', '21.1', ' 5.52', '297.3', '+30', '0.05', '160', '-40', '+043', '-03:03'], ['2017 01 31 05:25', '10 18 05.61', '-08 32 59.2', '21.0', ' 5.68', '297.9', '+30', '0.11', '158', '-25', '+038', '-03:07'], ['2017 02 01 05:10', '10 10 22.93', '-07 27 40.7', '20.9', ' 5.82', '298.4', '+30', '0.18', '147', '-10', '+033', '-03:10']], [5.583333333333333, 5.666666666666667, 5.833333333333333, 5.916666666666667, 6.083333333333333, 6.166666666666667, 6.333333333333333], [46, 47, 47, 48, 49, 50, 52])
