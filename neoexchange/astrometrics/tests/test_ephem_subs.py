...
class TestLongTermScheduling(TestCase):
    ...
    def test_LongTermScheduling_with_body(self):
        ...
        expected_returned_params = (['2017 01 06', '2017 01 09'], [['2017 01 06 01:20', '02 13 50.14', '+31 54 14.0', '21.0', ' 4.69', '+79', '0.52', ' 31', '+62', '+059', '-00:47'], ['2017 01 09 01:20', '01 52 45.62', '+29 03 29.1', '21.2', ' 4.51', '+86', '0.84', ' 33', '+53', '+069', '-00:14']], [5.25, 4.666666666666667], [88, 88])
    ...
    def test_LongTermScheduling_with_body2_shorter_time_limit(self):
        ...
        expected_returned_params = (['2017 01 09', '2017 01 16', '2017 01 17', '2017 01 18', '2017 01 19', '2017 01 20', '2017 01 21', '2017 01 22', '2017 01 23', '2017 01 24', '2017 01 25', '2017 01 26', '2017 01 27', '2017 01 28', '2017 01 29', '2017 01 30'], [['2017 01 09 08:30', '11 07 53.60', '-19 20 19.8', '21.5', ' 1.03', '+30', '0.86', '106', '+26', '+021', '-02:18'], ['2017 01 16 08:25', '11 11 11.23', '-22 01 59.9', '21.3', ' 0.97', '+30', '0.82', ' 28', '+53', '+012', '-01:59'], ['2017 01 17 08:25', '11 11 28.60', '-22 24 52.3', '21.3', ' 0.97', '+30', '0.74', ' 27', '+42', '+016', '-01:55'], ['2017 01 18 08:25', '11 11 43.01', '-22 47 39.7', '21.2', ' 0.96', '+30', '0.64', ' 31', '+31', '+020', '-01:51'], ['2017 01 19 08:25', '11 11 54.34', '-23 10 21.4', '21.2', ' 0.96', '+30', '0.55', ' 38', '+20', '+023', '-01:48'], ['2017 01 20 08:25', '11 12 02.53', '-23 32 56.7', '21.2', ' 0.95', '+30', '0.45', ' 47', '+09', '+027', '-01:44'], ['2017 01 21 08:25', '11 12 07.47', '-23 55 24.9', '21.1', ' 0.95', '+30', '0.36', ' 56', '-01', '+030', '-01:40'], ['2017 01 22 08:25', '11 12 09.07', '-24 17 45.2', '21.1', ' 0.94', '+30', '0.27', ' 66', '-11', '+034', '-01:36'], ['2017 01 23 08:20', '11 12 07.27', '-24 39 52.1', '21.1', ' 0.94', '+30', '0.19', ' 76', '-22', '+037', '-01:37'], ['2017 01 24 08:20', '11 12 01.93', '-25 01 54.1', '21.0', ' 0.93', '+30', '0.12', ' 86', '-33', '+041', '-01:33'], ['2017 01 25 08:20', '11 11 52.97', '-25 23 45.5', '21.0', ' 0.93', '+30', '0.07', ' 96', '-43', '+044', '-01:29'], ['2017 01 26 08:20', '11 11 40.31', '-25 45 25.4', '21.0', ' 0.93', '+30', '0.03', '107', '-53', '+047', '-01:25'], ['2017 01 27 08:20', '11 11 23.85', '-26 06 52.7', '20.9', ' 0.93', '+30', '0.00', '117', '-62', '+050', '-01:21'], ['2017 01 28 08:20', '11 11 03.50', '-26 28 06.2', '20.9', ' 0.93', '+30', '0.00', '127', '-70', '+053', '-01:16'], ['2017 01 29 08:20', '11 10 39.18', '-26 49 04.8', '20.8', ' 0.93', '+30', '0.02', '136', '-71', '+053', '-01:12'], ['2017 01 30 08:25', '11 10 10.68', '-27 09 51.6', '20.8', ' 0.93', '+30', '0.06', '143', '-66', '+052', '-01:03']], [4.083333333333333, 3.9166666666666665, 3.8333333333333335, 3.6666666666666665, 3.5833333333333335, 3.4166666666666665, 3.3333333333333335, 3.1666666666666665, 3.1666666666666665, 3.0, 2.9166666666666665, 2.75, 2.6666666666666665, 2.5, 2.3333333333333335, 2.0833333333333335], [39, 37, 36, 36, 36, 35, 35, 34, 34, 34, 33, 33, 33, 32, 32, 32])
