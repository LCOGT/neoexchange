...
def mock_check_request_status_cadence(tracking_num):
    if True:
        return mock_check_request_status_cadence_V3(tracking_num)
    else:
        return mock_check_request_status_cadence_V2(tracking_num)

def mock_check_request_status_cadence_V2(tracking_num):
...
def mock_check_request_status_cadence_V3(tracking_num):
