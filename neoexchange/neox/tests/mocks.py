...
def mock_get_vizier_catalog_table(ra, dec, ref_width, ref_height, cat_name="GAIA-DR2", set_row_limit=10, rmag_limit="<=15.0"):
    ...
    column_units = { 'RAJ2000' : u.deg, 'DEJ2000' : u.deg, \
                     'e_RAJ2000' : u.mas, 'e_DEJ2000' : u.mas, \
                     'Gmag' : u.mag, 'e_Gmag' : u.mag, 'Dup' : ''
                   }
    fake_table = Table(rows=row_data, \
        names=('RAJ2000', 'DEJ2000', 'e_RAJ2000', 'e_DEJ2000', 'Gmag', 'e_Gmag', 'Dup'), \
