...
class BlocksValidationTest(FunctionalTest):
    ...
    def test_can_view_blocks(self):
        ...
        self.check_for_header_in_table('id_blocks',
            'Target Name Site Telescope Type Proposal Tracking Number Obs. Details Active? Observed? Reported?')
        testlines = [u'N999r0q CPT 1m0 LCO2015A-009 00042 5x42.0 secs Active None Not Reported',
                     u'N999r0q COJ 2m0 LCOEngineering 00043 7x30.0 secs Not Active 1 Reported']
