...
from ingest.views import BodySearchView,BodyDetailView, ScheduleCheck, ScheduleSuccess, SchedFormDisplay, ScheduleConfirm, ephemeris, home
...
urlpatterns = [
    ...
    url(r'^schedule/(?P<pk>\d+)/$', ScheduleCheck.as_view(), name='schedule-body'),
